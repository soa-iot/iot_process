...
public interface EquipmentInfoMapper {
	...
	/**
	 * 插入动设备检维修信息进动设备检维修信息表 IOT_EQUIPMENT_MOVE_INFO
	 * @param info
	 * @return
	 */
	 ...
	 * @return
	 */
	List<String> findSelectWelUnit(@Param("info") EquipmentInfo info);
	List<String> findSelectSecondclassEquipment(@Param("info") EquipmentInfo info);
	List<String> findSelectEquMemoOne(@Param("info") EquipmentInfo info);
}
