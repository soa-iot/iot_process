...
//				            }
			...
			$("#generateTestData").click(function(){
				...
				$.getJSON('/iot_process/report/problemTimeOverCount',{'beginTime':$("#startTime").val() == "" ? ins1.config.value : $("#startTime").val() ,'endTime':$("#endTime").val() == "" ? ins2.config.value : $("#endTime").val()},function(aj){
					if(aj.state==0){
						//初始化基本数据
						tableData=[{
						    "jc-total":0
